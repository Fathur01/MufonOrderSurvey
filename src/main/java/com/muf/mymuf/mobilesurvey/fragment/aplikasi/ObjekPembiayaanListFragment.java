...
import com.muf.mymuf.mobilesurvey.activity.ObjekPembiayaanActivity;

public class ObjekPembiayaanListFragment extends Fragment {

    private RelativeLayout notEmptyDataLayout;
    private RelativeLayout emptyDataLayout;

    public ObjekPembiayaanListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_objek_pembiayaan_list, container, false);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), ObjekPembiayaanActivity.class);
