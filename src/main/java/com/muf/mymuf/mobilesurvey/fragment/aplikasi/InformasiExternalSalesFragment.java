...
public class InformasiExternalSalesFragment extends Fragment {

    private RelativeLayout notEmptyDataLayout;
    private RelativeLayout emptyDataLayout;

    public InformasiExternalSalesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_informasi_external_sales, container, false);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), FormInformasiExternalSalesActivity.class);
