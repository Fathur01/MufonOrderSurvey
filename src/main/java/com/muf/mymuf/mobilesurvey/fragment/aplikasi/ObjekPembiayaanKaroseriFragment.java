...
import com.muf.mymuf.mobilesurvey.activity.FormObjekPembiayaanKaroseriActivity;

public class ObjekPembiayaanKaroseriFragment extends Fragment {

    private RelativeLayout notEmptyDataLayout;
    private RelativeLayout emptyDataLayout;

    public ObjekPembiayaanKaroseriFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_objek_pembiayaan_karoseri, container, false);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), FormObjekPembiayaanKaroseriActivity.class);
